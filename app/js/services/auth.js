...
(function() {
  angular.module('crdsAuth', []).factory("Auth", function($http, $rootScope, $q) {
    return {
      getCurrentUser: function() {
        var deferred;
        deferred = $q.defer();
        $http.get('/api/ministryplatformapi/PlatformService.svc/GetCurrentUserInfo').then(function(response) {
